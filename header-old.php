...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$boni_maddison_architects_description = get_bloginfo( 'description', 'display' );
			if ( $boni_maddison_architects_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $boni_maddison_architects_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
